<form id="listAreaStatForm" action="${ctx}/manage/workshop/areaStat?workshopId=${(workshopId)!}"  method ="get">
	...
	<div class="mis-srh-layout">
		...
		<div class="mis-btn-row indent1">
			<button onclick="easyui_window_update('listAreaStatForm','layout_center_tabs');" type="button" class="mis-btn mis-main-btn"><i class="mis-srh-ico"></i>查询</button>
	...
	<div class="mis-table-layout">
		<div class="mis-table-mod">
			<table id="listAreaStatTable" width="100%" border="0" cellpadding="0" cellspacing="0" class="mis-table">
				...
				<tbody>
					<@departmentWorkshopStatDirective deptName=(deptName[0])! type="area" workshopId=workshopId! orders=(orders)!'STUDENT_NUM.DESC'  limit=(pageBounds.limit)!10 page=(pageBounds.page)!1>
						<#if departmentWorkshopStats??>
							<#list departmentWorkshopStats as dws>
								<tr>
									<td>${(dws.department.parentDepartment.parentDepartment.deptName)!}</td>
									<td>${(dws.department.parentDepartment.deptName)!}</td>
	                ...
	                <tr>
	                    <td colspan="18">
	                    	 <#if paginator??>
						    	...
						    	<@p.pagination paginator=paginator formId="listAreaStatForm" divId="list_content"/>
							</#if>
	                    </td>
	                </tr>
	            </tfoot>
