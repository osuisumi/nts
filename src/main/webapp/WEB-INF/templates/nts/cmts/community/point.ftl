		...
		<ul class="mis-community-scoreinner">
			<li>
				<div class="mis-comm-Rtl">
					<h3><i class="mis-comm-decrib"></i>社区研修介绍</h3>
				</div>
				<p class="discrible">
					研修社区是教师培训中学、研、用培训思路中体现”用“的功能模块，主要围绕活跃教研学习氛围，促进交流拉近研修距离，体现学习成果实现教学实践进行建设，目的是让教师分享教学的宝贵经验和想法，共同提高教学创新能力。研修社区主要分为研说、创课、活动三大交流互动版块。
				</p>
			...
			<li>
				<div class="mis-comm-Rtl">
					<h3><i class="mis-comm-score"></i>社区积分</h3>
				</div>
