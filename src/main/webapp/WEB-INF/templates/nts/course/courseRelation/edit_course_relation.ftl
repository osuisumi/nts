                    ...
                    <div class="tc">
                        <div class="mis-check-mod">
                            <label class="mis-radio-tick">
                                <strong class="on">
                                    <i class="ico"></i>
                                    <input type="radio" name="jion" checked="checked" value="">
                                </strong>
                                <span>限本组成员参与</span>
                            </label>
                            <label class="mis-radio-tick">
                                <strong>
                                    <i class="ico"></i>
                                    <input type="radio" name="jion" value="">
                                </strong>
                                <span>限本校教师参与</span>
                            </label>
                            <label class="mis-radio-tick">
	                    ...
	                    <dt>
	                        ...
	                        <div class="course-ManastPower-srh">
	                            ...
	                            <div class="mis-course-Machoose-serch">
	                                ...
	                                <button type="button" onclick="$.ajaxQuery('listPrepareCourseForm','list_prepare_course_div',resetAddedStatu)" class="mis-btn mis-main-btn"><i class="mis-srh-ico"></i>查询</button>
