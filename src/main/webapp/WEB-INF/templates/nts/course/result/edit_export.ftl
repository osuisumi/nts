...
<div class="g-layer-box">
    ...
    <form id="courseResultExportFrom" action="${ctx}/manage/course/result/export" method="get" target="_blank">
    	<input type="hidden" name="trainId" value="${(trainId[0])!}">  
    	<input type="hidden" name="realName" value="${(realName[0])!}">
    	<input type="hidden" name="deptName" value="${(deptName[0])!}">
    	<input type="hidden" name="state" value="${(state[0])!}">
    	<input type="hidden" name="orders" value="REAL_NAME">
